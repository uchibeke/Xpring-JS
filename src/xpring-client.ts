...
import { AccountInfo, AccountInfoRequest, InjectionRequest, AccountData, InjectionResponse } from "../generated/rippled_pb";
...
class XpringClient {
   ...
   */
  public async sendXRP(wallet: Wallet, destination: string, amount: XRPAmount): Promise<InjectionResponse> {
